  ...
  <div class="px-6 py-4 w-full flex justify-between">
    <div class="flex items-center">
      <div class="relative">
        ...
        <span style="z-index: 1000;" class="absolute rounded-full w-4 h-4 flex justify-center items-center text-center bg-blue-300 top-0 right-0">
          <p style="font-family: Junegull; font-size: .50rem;" class="text-white">d</p>
        </span>
      </div>
